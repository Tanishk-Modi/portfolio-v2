...
const HeroSection = () => {
  ...
  return (
    <section id='home'>
      {/* Hero Section */}
      <div className="relative z-10 flex flex-col-reverse md:flex-row items-center justify-center gap-16 min-h-screen px-4 text-center md:text-left">
        {/* Left Column */}
        <div className="flex flex-col items-center md:items-start justify-center max-w-xl space-y-6">
